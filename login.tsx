...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Log In — Zumert" },
      { name: "description", content: "Log in to your Zumert account." },
    ],
  }),
  component: LoginPage,
});
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <div className="bg-gradient-hero px-5 pb-10 pt-12">
        ...
        <h1 className="mt-6 font-display text-3xl font-bold text-primary-foreground">Welcome back</h1>
        <p className="mt-1 text-primary-foreground/70">Log in to continue your job search</p>
      </div>
      ...
      <div className="mx-auto w-full max-w-lg flex-1 px-5 -mt-4">
        <div className="rounded-2xl bg-card p-6 shadow-elevated">
          ...
          <Button variant="outline" className="w-full rounded-xl" onClick={handleGoogleLogin}>
